...
runlasso=function(ind,df,variable,horizon, alpha = 1, alpha2 = 1, adaptive = FALSE){
  ...
  # No paper, elastic net: alpha = 0.5
  # Usar para alpha2 os mesmos valores quando formos fazer o AdaLASSO e AdaEN
...
#    if(variable %in% c("CPI","PCE")){ # comentario adicionado por Hudson
    # O objeto dummy nao estava sendo definido.
